...
<head>
 ...
 <link href="css/productHide.css" rel="stylesheet"> 
        ...
        <div class="col-lg-10 col-md-12 col-sm-12" style="margin-top: 7rem;">
            <div class="tab-pane fade active show right " id="allProduct" role="tabpanel" aria-labelledby="allProduct">          
                <div class = "panel panel-default" >
                    <div class="card" >
                        <div class="card-body">
                            <form action="saleschannel-allproduct-hide-search" method="get"  id="saleschannel-allproduct-show-search">                                     
                                <div class="row">
                                    <div class="col">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link " id="pills-conHang-tab" href="/saleschannel-allproduct-show">Đang bán</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " id="pills-hetHang-tab"  href="/saleschannel-allproduct-soldout">Hết hàng</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active" id="pills-daAn-tab"  href="/saleschannel-allproduct-hide">Đã ẩn</a>
                                            </li>                           
                                        </ul>
                                    </div>
                                        ...
                                        <c:forEach items="${listImageProduct}" var="product">
                                            <div class="col-lg-md-3" style="padding: 15px 15px">                                            
                                                <div class="card" style="width: 250px">     
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                           <button type="button" class="btn btn-tw showProduct" name="showProduct">Bán</button> 
                                                        </div>
                                                        <div class="col-6">
