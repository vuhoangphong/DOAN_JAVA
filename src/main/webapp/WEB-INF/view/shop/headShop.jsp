...
.btn-login{
    ...
    <div class="container-fluid" >         
        <div class="row" style="border-bottom: ridge;">
            <div class="input-group" style="position: fixed;width: 100%; z-index: 1000; background-color: white;border-bottom: 2px solid;">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12">
                    <c:if test="${not empty pageContext.request.userPrincipal.name}">
                        <div class="nav-item dropdown from group row btn-login" id="nameAvatarLogin" >
                            <!-- Avatar -->
                            <a href="/profile"> <img src="/getAvatarShop?idShop=${shop.idShop}" class="rounded-circle mr-3" height="30px" width="30px" alt="avatar"></a>
                            <a class="nav-link dropdown-toggle font-weight-bold mb-2" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${shop.nameShop}</a>
