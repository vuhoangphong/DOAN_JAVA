...
<head>
  ...
  <link href="css/productSoldout.css" rel="stylesheet">
        ...
        <div class="col-lg-10 col-md-12 col-sm-12" style="margin-top: 7rem;">
            <div class="tab-pane fade active show right" id="allProduct" role="tabpanel" aria-labelledby="allProduct">          
                <div class = "panel panel-default" >
                    <div class="card" >
                        <div class="card-body">
                            <form action="saleschannel-allproduct-soldout-search" method="get"  id="saleschannel-allproduct-show-search">                                     
                                <div class="row">
                                    <div class="col">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" id="pills-hetHang-tab"  href="/saleschannel-allproduct-soldout">Hết hàng</a>
                                            </li>
                                            <li class="nav-item">
